...
<head>
    <meta charset="utf-8">
    <title>Cetakin - Printing Solution</title>
    ...
    <link rel="shortcut icon" href="public/img/cetakin_black.png">
</head>
<body>
<!-- navbar -->
    ...
    <div class="navbar navbar-inverse navbar-fixed-top">
        <div class="navbar-inner">
            <div class="container">
                ...
                <h1 class="brand"><a href="index.php">Cetakin</a></h1>
                <!-- navigation -->
...
<div id="header-wrapper" class="header-slider">
    <header class="clearfix">
        <div class="logo">
            <img src="public/img/cetakin_white.png" alt="" />
        </div>
        <div class="container">
            <div class="row">
                <div class="span12">
                        ...
                        <ul class="slides">
                            <li>
                                <p class="home-slide-content">
                                    <strong>Upload</strong> it
                                </p>
                            </li>
                            <li>
                                <p class="home-slide-content">
                                    <strong>Pay</strong> it
                                </p>
                            </li>
                            <li>
                                <p class="home-slide-content">
        ...
        <div class="row">
            <div class="span6 alignright flyLeft">
                <blockquote class="large">
                    Too much thinking? Just do it <cite>Nike</cite>
                </blockquote>
            </div>
        ...
        <div class="row">
            <div class="span3 animated-fast flyIn">
                <div class="service-box">
                    <img src="public/img/icons/laptop.png" alt="" />
                    <h2>Web design</h2>
                    <p>
            ...
            <div class="span3 animated flyIn">
                <div class="service-box">
                    <img src="public/img/icons/lab.png" alt="" />
            ...
            <div class="span3 animated-fast flyIn">
                <div class="service-box">
                    <img src="public/img/icons/camera.png" alt="" />
                    <h2>Photography</h2>
                    <p>
                        Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                    </p>
            ...
            <div class="span3 animated-slow flyIn">
                <div class="service-box">
                    <img src="public/img/icons/basket.png" alt="" />
                    <h2>Ecommerce</h2>
                    <p>
                        Lorem Ipsum is simply dummy text of the printing and typesetting industry.
                    </p>
            ...
            <div class="span12">
                <div id="portfolio-wrap">
                    ...
                    <div class="portfolio-item grid print photography">
                        <div class="portfolio">
                            <a href="public/img/works/big.jpg" data-pretty="prettyPhoto[gallery1]" class="portfolio-image">
                                <img src="public/img/works/1.png" alt="" />
                    ...
                    <div class="portfolio-item grid print design web">
                        <div class="portfolio">
                            <a href="public/img/works/big.jpg" data-pretty="prettyPhoto[gallery1]" class="portfolio-image">
                                <img src="public/img/works/2.png" alt="" />
                                <div class="portfolio-overlay">
                                    <div class="thumb-info">
                                        <h5>Portfolio name</h5>
                                        <i class="icon-plus icon-2x"></i>
                    ...
                    <div class="portfolio-item grid print design">
                        <div class="portfolio">
                            <a href="public/img/works/big.jpg" data-pretty="prettyPhoto[gallery1]" class="portfolio-image">
                                <img src="public/img/works/3.png" alt="" />
                                <div class="portfolio-overlay">
                                    <div class="thumb-info">
                                        <h5>Portfolio name</h5>
                                        <i class="icon-plus icon-2x"></i>
                    ...
                    <div class="portfolio-item grid photography web">
                        <div class="portfolio">
                            <a href="public/img/works/big.jpg" data-pretty="prettyPhoto[gallery1]" class="portfolio-image">
                                <img src="public/img/works/4.png" alt="" />
                                <div class="portfolio-overlay">
                                    <div class="thumb-info">
                                        <h5>Portfolio name</h5>
                                        <i class="icon-plus icon-2x"></i>
                    ...
                    <div class="portfolio-item grid photography web">
                        <div class="portfolio">
                            <a href="public/img/works/big.jpg" data-pretty="prettyPhoto[gallery1]" class="portfolio-image">
                                <img src="public/img/works/5.png" alt="" />
                                <div class="portfolio-overlay">
                                    <div class="thumb-info">
                                        <h5>Portfolio name</h5>
                                        <i class="icon-plus icon-2x"></i>
                    ...
                    <div class="portfolio-item grid photography web">
                        <div class="portfolio">
                            <a href="public/img/works/big.jpg" data-pretty="prettyPhoto[gallery1]" class="portfolio-image">
                                <img src="public/img/works/6.png" alt="" />
                                <div class="portfolio-overlay">
                                    <div class="thumb-info">
                                        <h5>Portfolio name</h5>
                                        <i class="icon-plus icon-2x"></i>
                    ...
                    <div class="portfolio-item grid photography web">
                        <div class="portfolio">
                            <a href="public/img/works/big.jpg" data-pretty="prettyPhoto[gallery1]" class="portfolio-image">
                                <img src="public/img/works/7.png" alt="" />
                                <div class="portfolio-overlay">
                                    <div class="thumb-info">
                                        <h5>Portfolio name</h5>
                                        <i class="icon-plus icon-2x"></i>
                    ...
                    <div class="portfolio-item grid photography">
                        <div class="portfolio">
                            <a href="public/img/works/big.jpg" data-pretty="prettyPhoto[gallery1]" class="portfolio-image">
                                <img src="public/img/works/8.png" alt="" />
                                <div class="portfolio-overlay">
                                    <div class="thumb-info">
                                        <h5>Portfolio name</h5>
                                        <i class="icon-plus icon-2x"></i>
                    ...
                    <div class="portfolio-item grid photography web">
                        <div class="portfolio">
                            <a href="public/img/works/big.jpg" data-pretty="prettyPhoto[gallery1]" class="portfolio-image">
                                <img src="public/img/works/9.png" alt="" />
                                <div class="portfolio-overlay">
                                    <div class="thumb-info">
                                        <h5>Portfolio name</h5>
                                        <i class="icon-plus icon-2x"></i>
                    ...
                    <div class="portfolio-item grid design web">
                        <div class="portfolio">
                            <a href="public/img/works/big.jpg" data-pretty="prettyPhoto[gallery1]" class="portfolio-image">
                                <img src="public/img/works/10.png" alt="" />
                                <div class="portfolio-overlay">
                                    <div class="thumb-info">
                                        <h5>Portfolio name</h5>
                                        <i class="icon-plus icon-2x"></i>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="span3">
                <div class="home-post">
                    <div class="post-image">
                        <img class="max-img" src="public/img/blog/img1.jpg" alt="" />
                    </div>
                    <div class="post-meta">
            ...
            <div class="span3">
                <div class="home-post">
                    <div class="post-image">
                        <img class="max-img" src="public/img/blog/img2.jpg" alt="" />
                    </div>
                    <div class="post-meta">
                        <i class="icon-file icon-2x"></i>
                        <span class="date">June 19, 2013</span>
            ...
            <div class="span3">
                <div class="home-post">
                    <div class="post-image">
                        <img class="max-img" src="public/img/blog/img3.jpg" alt="" />
                    </div>
                    <div class="post-meta">
                        <i class="icon-file icon-2x"></i>
            ...
            <div class="span3">
                <div class="home-post">
                    <div class="post-image">
                        <img class="max-img" src="public/img/blog/img4.jpg" alt="" />
                    </div>
                    <div class="post-meta">
                        <i class="icon-file icon-2x"></i>
    ...
    <div class="container">
        <div class="row">
            <div class="span6 offset3">
                ...
                <p class="copyright">
                    &copy; Cetakin Co. All rights reserved.
                <div class="credits">
                    <!--
